...
- :py:meth:`~irsim.env.env_base.EnvBase.get_msg`: capture a complete ROS-style simulation message.
- :py:meth:`~irsim.env.env_base.EnvBase.receive_msg`: apply external ROS-style odometry to simulation objects.
