...
.. toctree::
   ...
   /api/irsim/world/sensors/lidar2d/index
   /api/irsim/world/sensors/sensor_factory/index
...
.. autoapisummary::
   ...
   irsim.world.sensors.SensorFactory


Package Contents
----------------

.. py:class:: Lidar2D(state: Optional[numpy.ndarray] = None, obj_id: int = 0, range_min: float = 0, range_max: float = 10, angle_range: float = pi, number: int = 100, scan_time: float = 0.1, noise: bool = False, std: float = 0.2, angle_std: float = 0.02, offset: Optional[list[float]] = None, alpha: float = 0.3, has_velocity: bool = False, **kwargs)
