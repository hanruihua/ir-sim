...
.. toctree::
   ...
   /api/irsim/world/map/obstacle_map/index
...
.. py:class:: Map(width: int = 10, height: int = 10, resolution: float = 0.1, obstacle_list: Optional[list] = None, grid: Optional[numpy.ndarray] = None)
   ...
   :param obstacle_list: list of obstacle objects for collision detection
   :type obstacle_list: list
   :param grid: grid map data for collision detection.
