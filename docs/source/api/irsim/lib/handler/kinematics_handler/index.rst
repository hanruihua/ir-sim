...
.. py:class:: KinematicsHandler(name, noise: bool = False, alpha: Optional[list] = None)
...
.. py:class:: AckermannKinematics(name, noise: bool = False, alpha: Optional[list] = None, mode: str = 'steer', wheelbase: float = 1.0)
