...
.. py:class:: EnvPlot3D(world: Any, objects: Optional[list[Any]] = None, saved_figure: Optional[dict[str, Any]] = None, figure_pixels: Optional[list[int]] = None, show_title: bool = True, **kwargs: Any)
   ...
   .. py:method:: draw_points(points: Optional[Union[list, numpy.ndarray]], s: int = 10, c: str = 'm', refresh: bool = True, **kwargs: Any) -> None
   ...
   .. py:method:: draw_quiver(point: Optional[numpy.ndarray], refresh: bool = False, **kwargs: Any) -> None
   ...
   .. py:method:: draw_quivers(points: Union[list, numpy.ndarray], refresh: bool = False, **kwargs: Any) -> None
   ...
   .. py:method:: draw_trajectory(traj: Union[list, numpy.ndarray], traj_type: str = 'g-', label: str = 'trajectory', show_direction: bool = False, refresh: bool = False, **kwargs: Any) -> None
