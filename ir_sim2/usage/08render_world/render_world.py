...
for i in range(3000):
    ...
    env.render(0.05, robot_color='g', show_traj=True, show_text=True, goal_color='r', show_goal=True, traj_type='-g', show_sensor=True, figure_args={'bbox_inches':'tight', 'pad_inches': 0} )
