...
.. py:class:: ObjectBase(shape: Optional[dict] = None, kinematics: Optional[dict] = None, state: list = [0, 0, 0], velocity: list = [0, 0], goal: Optional[list] = None, role: str = 'obstacle', color: str = 'k', static: bool = False, vel_min: list = [-1, -1], vel_max: list = [1, 1], acce: list = [inf, inf], angle_range: list = [-pi, pi], behavior: Optional[dict] = None, goal_threshold: float = 0.1, sensors: Optional[dict] = None, arrive_mode: str = 'position', description: Optional[str] = None, group: int = 0, state_dim: Optional[int] = None, vel_dim: Optional[int] = None, unobstructed: bool = False, fov: Optional[float] = None, fov_radius: Optional[float] = None, **kwargs)
   ...
   .. py:method:: set_state(state: Union[list, numpy.ndarray] = [0, 0, 0], init: bool = False)
   ...
   .. py:method:: set_velocity(velocity: Union[list, numpy.ndarray] = [0, 0], init: bool = False)
   ...
   .. py:method:: set_random_goal(obstacle_list, init: bool = False, free: bool = True, goal_check_radius: float = 0.2, range_limits: list = None, max_attempts: int = 100)
   ...
   .. py:method:: set_goal(goal: Union[list, numpy.ndarray] = [10, 10, 0], init: bool = False)
   ...
   .. py:method:: plot_object_image(ax, state: Optional[numpy.ndarray] = None, vertices: Optional[numpy.ndarray] = None, description: str = None, **kwargs)
...
.. py:class:: RobotDiff(color='g', state_dim=3, **kwargs)
...
.. py:class:: RobotAcker(color='y', state_dim=4, description='car_green.png', **kwargs)
...
.. py:class:: RobotOmni(color='g', state_dim=3, **kwargs)
...
.. py:class:: ObjectFactory
   ...
   .. py:method:: create_from_parse(parse, obj_type='robot')
   ...
   .. py:method:: create_from_map(points, reso=0.1)
   ...
   .. py:method:: create_object(obj_type: str = 'robot', number: int = 1, distribution: dict = {'name': 'manual'}, state: list = [1, 1, 0], goal: list = None, **kwargs)
   ...
   .. py:method:: create_robot(kinematics=dict(), **kwargs)
   ...
   .. py:method:: create_obstacle(kinematics=dict(), **kwargs)
   ...
   .. py:method:: generate_state_list(number=1, distribution={'name': 'manual'}, state=[1, 1, 0], goal=[1, 9, 0])
