...
.. py:function:: convert_list_length(input_data, number=0)
...
.. py:function:: convert_list_length_dict(input_data, number=0)
...
.. py:function:: is_list_of_dicts(lst)
...
.. py:function:: is_list_of_numbers(lst)
...
.. py:function:: is_list_of_lists(lst)
...
.. py:function:: is_list_not_list_of_lists(lst)
...
.. py:function:: get_transform(state)
...
.. py:function:: get_affine_transform(state)
