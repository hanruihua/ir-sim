...
.. toctree::
   ...
   /api/irsim/env/index
   /api/irsim/global_param/index
   /api/irsim/gui/index
   /api/irsim/lib/index
   /api/irsim/util/index
   /api/irsim/world/index
...
.. py:class:: EnvBase(world_name: Optional[str] = None, display: bool = True, disable_all_plot: bool = False, save_ani: bool = False, full: bool = False, log_file: Optional[str] = None, log_level: str = 'INFO')
   ...
   .. py:method:: step(action: Optional[Union[numpy.ndarray, list]] = None, action_id: Optional[Union[int, list]] = 0)
   ...
   .. py:method:: render(interval: float = 0.02, figure_kwargs=dict(), mode: str = 'dynamic', **kwargs)
   ...
   .. py:method:: draw_trajectory(traj: list, traj_type: str = 'g-', **kwargs)
   ...
   .. py:method:: draw_points(points: list, s: int = 30, c: str = 'b', refresh: bool = True, **kwargs)
   ...
   .. py:method:: draw_box(vertex: numpy.ndarray, refresh: bool = False, color: str = '-b')
   ...
   .. py:method:: end(ending_time: float = 3.0, **kwargs)
   ...
   .. py:method:: reset_plot()

      Reset the environment figure.



   .. py:method:: random_obstacle_position(range_low: list = [0, 0, -3.14], range_high: list = [10, 10, 3.14], ids: Optional[list] = None, non_overlapping: bool = False)
   ...
   .. py:method:: random_polygon_shape(center_range: list = [0, 0, 10, 10], avg_radius_range: list = [0.1, 1], irregularity_range: list = [0, 1], spikeyness_range: list = [0, 1], num_vertices_range: list = [4, 10])
   ...
   .. py:method:: create_obstacle(**kwargs)
   ...
   .. py:method:: add_object(obj: irsim.world.ObjectBase)
   ...
   .. py:method:: add_objects(objs: list)
   ...
   .. py:method:: delete_object(target_id: int)
   ...
   .. py:method:: delete_objects(target_ids: list)
   ...
   .. py:method:: get_lidar_scan(id: int = 0)
   ...
   .. py:method:: get_lidar_offset(id: int = 0)
   ...
   .. py:method:: get_obstacle_info_list()
   ...
   .. py:method:: get_robot_info(id: int = 0)
   ...
   .. py:method:: get_map(resolution: float = 0.1)
   ...
   .. py:method:: save_figure(save_name: Optional[str] = None, include_index: bool = False, save_gif: bool = False, **kwargs)
...
.. py:function:: make(world_name=None, projection=None, **kwargs) -> env.EnvBase
   ...
   :param world_name: The name of the world YAML configuration file.
                      If not specified, the default name of the current Python script with
                      '.yaml' extension will be used.
   :type world_name: str, optional
   :param projection: The projection type of the environment.
                      Default is None for 2D environment. If set to "3d", creates a 3D
                      plot environment.
   :type projection: str, optional
   :param \*\*kwargs: Additional keyword arguments passed to :py:class:`.EnvBase`
   ...
   :returns: The created environment object. Returns :py:class:`.EnvBase3D`
