...
.. autoapisummary::
   ...
   irsim.env.env_base.keyboard_module
   irsim.env.env_base.BACKEND_PREFERENCES
   irsim.env.env_base.backends
   irsim.env.env_base.backend_set
...
.. autoapisummary::
   ...
   irsim.env.env_base.EnvBase


Module Contents
---------------

.. py:data:: keyboard_module
   :value: True


.. py:data:: BACKEND_PREFERENCES
